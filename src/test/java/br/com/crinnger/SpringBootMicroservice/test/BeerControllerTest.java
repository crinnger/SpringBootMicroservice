...
class BeerControllerTest {
	...
	void testGetBeer() throws Exception{
		this.mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/beer/" + UUID.randomUUID())
	...
	void testHandleUpdate()   throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/beer/" + UUID.randomUUID())
				.contentType(MediaType.APPLICATION_JSON)
				.content(json))
